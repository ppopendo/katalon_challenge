...
WebUI.navigateToUrl(GlobalVariable.URL_SLIDER2)
...
TestObject slider_element  = findTestObject('Object Repository/GenericSelenium/JQUERY/SLIDER/slider_element')
...
builder_action.moveByOffset(44, 0).release().perform()
WebUI.delay(5)
WebUI.closeBrowser()
