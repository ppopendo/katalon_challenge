...
login_page.enter_password(GlobalVariable.DEFAULT_PASSWORD)
login_page.click_login_button()
String error_message_element = login_page.get_error_message()
assert error_message == error_message_element
WebUI.closeBrowser()
