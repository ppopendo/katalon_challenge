...
import pages.SauceDemoCartPage as CartPage
...
Boolean is_cart_empty = products_page.is_cart_count_empty()
assert is_cart_empty
products_page.open_shooping_cart()
is_cart_empty = cart_page.is_shooping_list_empty()
assert is_cart_empty
