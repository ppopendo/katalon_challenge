...
String item_desc_element =  products_page.get_item_desc(item_name)
products_page.open_item_name_details(item_name)
String item_desc_detail_element =  product_details.get_item_desc()
assert item_desc_element == item_desc_detail_element
