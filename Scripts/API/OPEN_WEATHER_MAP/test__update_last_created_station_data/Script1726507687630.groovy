...
List station_list = json_slurper.parseText(response.getResponseText())
...
response = WS.sendRequestAndVerify(findTestObject('API/OPEN_WEATHER_MAP/update_station', [('uri') : GlobalVariable.URI, ('resource_stations') : GlobalVariable.RESOURCE_STATION
            , ('appid') : GlobalVariable.APPID, ('external_station_id') : external_station_id, ('station_name') : station_name, ('latitude') : latitude, ('longitude') : longitude 
            , ('altitude') : altitude, ('station_id') : station_list[-1]['id']]))
